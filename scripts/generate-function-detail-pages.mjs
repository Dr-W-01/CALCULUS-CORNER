                ...
                <section class="content-card">
                    ...
                    <div class="section-body graph-facts-row">
                        <div class="w-full md:w-1/2 shrink-0">
                            <div class="graph-wrap-sm graph-wrap-interactive max-w-[22rem] mx-auto overflow-hidden rounded-xl border border-[#5c3838]">
                    ...
                    <div class="section-body">
                        <div class="graph-trio">
                            <div class="deriv-col">
                                ...
                                <div class="graph-wrap-sm graph-wrap-interactive overflow-hidden rounded-xl border border-[#5c3838]">
